...
st.markdown("<h4 style='text-align: center;'>Write a movie's name or select a movie from the dropdown, and we'll recommend similar movies based on your choice.</h4>", unsafe_allow_html=True)
